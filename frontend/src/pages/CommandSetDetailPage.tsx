      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800 pb-5">
        ...
        <div className="flex items-center gap-2.5">
          <Button
            ...
            onClick={() => navigate(`/operations?tab=capture&setId=${commandSet.setId}`)}
          >
            Run collection
          </Button>
          {!commandSet.isDefault && (
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 bg-zinc-950 border border-zinc-800 rounded-xl text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-zinc-500"
              />
            </div>

            {/* Target Driver (Immutable after registration) */}
            <div>
              <label className="block text-xs font-semibold text-zinc-300 mb-1.5">
              ...
              <input
                type="text"
                disabled
                value={commandSet.deviceType}
                className="w-full px-3.5 py-2 bg-zinc-900 border border-zinc-800 rounded-xl text-sm text-zinc-400 font-mono cursor-not-allowed"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Optional scope or audit purpose..."
                className="w-full px-3.5 py-2 bg-zinc-950 border border-zinc-800 rounded-xl text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-zinc-500"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 bg-zinc-950 border border-zinc-800 rounded-xl font-mono text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-zinc-500 leading-relaxed"
              />
            </div>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                {syntaxValidation.hasErrors && (
                  <ul className="list-disc list-inside text-rose-300 text-xs space-y-0.5 pt-1">
