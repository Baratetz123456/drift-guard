          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative ml-1" ref={profileRef}>
              <button
                ...
                className="flex items-center gap-2.5 p-1.5 pl-3 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-zinc-700 transition-all cursor-pointer group"
                title="Operator Profile & Region"
              >
                <div className="text-right hidden sm:block">
                  <div className="text-sm font-semibold text-zinc-200 group-hover:text-white transition-colors leading-tight">
