...
> When operating within the DriftGuard repository, **DriftGuard Brand & Visual Standards (`brand-driftguard` and `AGENTS.md`) take absolute precedence** over generic design commands:
